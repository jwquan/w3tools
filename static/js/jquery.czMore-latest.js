        ...
        return this.each(function () {
            ...
            function minusClick(recordset) {
                $(recordset).children("#btnMinus").click(function () {
					...
					console.log(recordset.children('div.fieldRow.clearfix').children().children().children('div:nth-child(1)').children('div.controls').children('select').children());
                });
				 $(recordset).children('div.fieldRow.clearfix').children().children().children('div:nth-child(1)').children('div.controls').children('select').change(function () {
					 if($(this).val()!='text'){
						$(this).parent().parent().parent().parent().children('.col-md-3:nth-child(3)').children().children('div').children('input').attr('type','file');
					}else{
						$(this).parent().parent().parent().parent().children('.col-md-3:nth-child(3)').children().children('div').children('input').attr('type','text');
					}
				 });
